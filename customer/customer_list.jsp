...
<head>
    ...
    <style>
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .user-row { display: flex; align-items: center; gap: 10px; padding: 8px 8px; }
        ...
        .logout-btn { display: flex; align-items: center; gap: 8px; padding: 7px 10px; border-radius: 7px; font-size: 12px; color: #6b7280; cursor: pointer; text-decoration: none; transition: background 0.12s; width: 100%; }
